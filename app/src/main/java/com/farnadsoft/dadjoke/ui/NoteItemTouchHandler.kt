...
class NoteItemTouchHandler(val jokeViewModel: MainViewModel, val adapter: JokeAdapter) : ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT + ItemTouchHelper.RIGHT) {
